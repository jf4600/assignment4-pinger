...
###############################################################################
        ...
        type, code, sequence, checksum, packetID = struct.unpack("bbHHh", icmpHead)

        if packetID == ID: sysBytes = struct.calcsize("p")
        timeSent = struct.unpack("p", recPacket[28:28 + sysBytes])
